...
const Cart = () => {
  ...
  const totalCost = selectedService.reduce(
    (previous, service) => previous + service.Fees,
    0
  );
    ...
    <div className="my-4">
      {totalCost ? (
        <Container>
          <Row>
            <Col md={8}>
              {setSelectedService.map((service) => (
                <Row className="bg-info my-3">
                  ...
                  <Col className="py-2">
                    ...
                    <p className="m-0">{service.specialist}</p>
                    <Row>
                      <Col>
                        <Row>
                          <h6 className="my-1">Fees:${service.Fees}</h6>
                        </Row>
                        <Row>
                          <Col>
                            <Rating
            ...
            >
              <div className="text-center my-2">
                ...
                <button
                  onClick={() => {
                    setSelectedService([]);
                    alert("Thanks for Booking an Appoinments!");
                  }}
